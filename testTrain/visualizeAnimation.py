...
dataset = dataLoadTool.load_tfrecords(
    srcfile="E:/DGMR/data/20200718/train/random_crops_256/seq-24-00000-of-02100.tfrecord")
row = next(iter(dataset))

# 24, 256, 256, 1
ani = plot_animation(row["radar_frames"].numpy())
# ani.save('E:/DGMR/visualizeRow.gif', writer='imagemagick', fps=100)
plt.show()
